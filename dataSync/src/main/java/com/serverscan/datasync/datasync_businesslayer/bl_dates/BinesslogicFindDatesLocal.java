...
public class BinesslogicFindDatesLocal extends BinesslogicFindDatesRemote {


    public BinesslogicFindDatesLocal(Context context) {
        super(context);
    }
    ...
    public String getDates(@NotNull Long version) {
        ...
        try{
            getNameTabkeGet="date_updatelocal";
            ...
            getDateupdate=new BinesslogicParserDates(context,version).prossecingBremy(cursorNewVesionGattServer,getNameTabkeGet);
