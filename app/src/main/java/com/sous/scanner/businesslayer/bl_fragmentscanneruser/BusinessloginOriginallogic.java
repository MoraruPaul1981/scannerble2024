...
public class BusinessloginOriginallogic {
    ...
    public void materialtextViewGetLastStateCurrentUser(@NonNull SharedPreferences preferences,
                                                  @NonNull MaterialTextView materialtextview_last_get_currentuser,
                                                  @NonNull Message messageClient) {
        try{
