...
public class LauntchActivityAfterUpdatePOAndAsync {
    ...
    public void forvardDashboard(@NonNull Context context){
        try {
            ...
            Интент_ЗапускаетDashboard.setFlags( Intent.FLAG_ACTIVITY_CLEAR_TOP |Intent.FLAG_ACTIVITY_SINGLE_TOP);
    ...
    public void forvardActivityPassword(@NonNull Context context) {
        try{
            ...
            Интент_ЗапускаетPasswords.setFlags( Intent.FLAG_ACTIVITY_CLEAR_TOP |Intent.FLAG_ACTIVITY_SINGLE_TOP);
            Bundle bundle=new Bundle();
